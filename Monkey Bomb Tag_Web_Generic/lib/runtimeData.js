const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/Monkey Bomb Tag_Web_Generic.loader.js",
        dataURL: "bin/Monkey Bomb Tag_Web_Generic.data.unityweb",
        frameworkURL: "bin/Monkey Bomb Tag_Web_Generic.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/Monkey Bomb Tag_Web_Generic.wasm.unityweb",
        symbolsURL: "",
